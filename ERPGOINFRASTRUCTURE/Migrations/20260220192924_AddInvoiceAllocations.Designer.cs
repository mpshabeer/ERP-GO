...
namespace ERPGOInfrastructure.Migrations
{
    ...
    [Migration("20260220192924_AddInvoiceAllocations")]
    partial class AddInvoiceAllocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERPGODomain.Entities.PaymentAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERPGODomain.Entities.ReceiptAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERPGODomain.Entities.PaymentAllocation", b =>
                {
                    b.HasOne("ERPGODomain.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("ERPGODomain.Entities.ReceiptAllocation", b =>
                {
                    b.HasOne("ERPGODomain.Entities.Receipt", "Receipt")
                        .WithMany()
